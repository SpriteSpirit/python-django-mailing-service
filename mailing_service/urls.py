...
urlpatterns = [
    path('dashboard/', cache_page(60)(dashboard), name='dashboard'),
    path('moderator_dashboard/', cache_page(60)(moderator_dashboard), name='moderator_dashboard'),
    ...
    path('log_list/', cache_page(60)(MailingLogListView.as_view()), name='log_list'),
