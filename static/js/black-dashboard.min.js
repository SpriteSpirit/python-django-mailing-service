...
$(document).ready(function() {
    ...
    0 != $(".navbar[color-on-scroll]").length && (blackDashboard.checkScrollForTransparentNavbar(),
...
blackDashboard = {
    ...
    initMinimizeSidebar: function() {
        ...
        $("#minimizeSidebar").click(function() {
            ...
            sidebar_mini_active = !1,
            blackDashboard.showSidebarMessage("Sidebar mini deactivated...")) : ($("body").addClass("sidebar-mini"),
